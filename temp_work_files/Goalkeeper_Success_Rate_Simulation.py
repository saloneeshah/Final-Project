...
class Player:
    ...
    def penalty_sim(self, striker, print_result=False, team=False, consider_direction=False):
        ...
        if not consider_direction:
            return (self.wins_case1 / 1000000) * 100
        else:
            if team:
                return (self.wins_case2 / 1000000) * 100
            else:
                return (self.wins_case3 / 1000000) * 100
...
if __name__ == '__main__':
    ...
    print("Beginning Scenario 1 - Goalie jumps in Random Direction")
    print("-------------------------------------------------------")
    ...
    for match in range(1000000):
        ...
        win_perc = goal_keeper.penalty_sim(kick_taker, print_result=False, team=False, consider_direction=False)
    print("Win %:", win_perc)
    ...
    for match in range(1000000):
        kick_taker = choice(Player.team)
        goal_keeper = Player.keeper
        win_perc = goal_keeper.penalty_sim(kick_taker, print_result=False, team=True, consider_direction=True)
    print("Win %:", win_perc)
    ...
    # run scenario 1 for team 2
    for match in range(1000000):
        kick_taker = choice(Player.team)
        goal_keeper = Player.keeper
        win_perc = goal_keeper.penalty_sim(kick_taker, print_result=False, team=False, consider_direction=True)
    print("Win %:", win_perc)
    # ------------------------------------------------------------------------------------------------------------------
